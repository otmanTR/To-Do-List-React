...
# 📖 To Do List React Project <a name="about-project"></a>


**To Do List React Project is a SPA which you coul make your to do list easly *
...
Clone this repository to your desired folder:https://git@github.com:otmanTR/To-Do-List-React.git
